...
struct ImGui_ImplOpenGL3_Render_Data {
...
// thread local?
static ImGui_ImplOpenGL3_Render_Data g_ImGui_ImplOpenGL3_Render_Data;

void ImGui_ImplOpenGL3_PrepareDrawList(const ImDrawList *cmd_list) {
  ImGui_ImplOpenGL3_Data* bd = ImGui_ImplOpenGL3_GetBackendData();
  ...
  // - On NVIDIA drivers we got reports that using orphaning + glBufferSubData()
  // led to glitches when using multi-viewports.
...
// TODO can I use the ImDrawData* instead of the global ImGui_ImplOpenGL3_Render_Data
void ImGui_ImplOpenGL3_RenderDrawList(const ImDrawList *cmd_list) {
  auto &render_data = g_ImGui_ImplOpenGL3_Render_Data;
  ImGui_ImplOpenGL3_Data* bd = ImGui_ImplOpenGL3_GetBackendData();
  auto fb_height = render_data.fb_height;
  auto fb_width = render_data.fb_width;
  auto draw_data = render_data.draw_data;
  auto vertex_array_object = render_data.vertex_array_object;

  ImGui_ImplOpenGL3_PrepareDrawList(cmd_list);
  ...
  for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
    ...
    if (pcmd->UserCallback != NULL) {
      ...
      const auto &clip_off = render_data.clip_off;
      const auto &clip_scale = render_data.clip_scale;
...
void    ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
    ...
    if (fb_width <= 0 || fb_height <= 0)
        return;
    render_data.fb_width = fb_width;
    render_data.fb_height = fb_height;
    ...
    GLuint &vertex_array_object = render_data.vertex_array_object;
    ...
    ImVec2 &clip_off = render_data.clip_off;
    ImVec2 &clip_scale = render_data.clip_scale;
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        ImGui_ImplOpenGL3_RenderDrawList(cmd_list);
    }
